        ...
        <div class="media mt-3 pl-2">
            ...
            <form class="row g-3" action="includes/signup.inc.php" method="POST">
                ...
                <div class="col-12">
                  ...
                  <input type="password" class="form-control" name="passwordRepeat"  placeholder="Enter your password">
                </div>
                
             
                <div class="col-12">
                  <button type="submit" class="btn btn-success" name="submit" value="signup">signup</button>
